function pf_new_th=profile_update3(pf,gene_sq,tf_sq,max_num,f,prior)
...
%                 size(pf_new)
                ...
                pf_new{index_temp,6}=compute_prior(prior, pf_new{index_temp,4});
            end
...
%                 size(pf_new)
    ...
    pf_new_th=adjusted_profile_thresholding2_new(pf_new,max_num,tf_sq,gene_sq);
