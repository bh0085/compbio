function MCMC_noonlinear(input)
...
% saved_filename=filename(1,12:end-4);

save(output_filename)

% output=strcut('nonlinear_model',model,'linear_model',model_linear,'candidates',candidates,'error_energy',error_en_new,'total_error',total_error,'ratio',ratio,'error_test',error_test,'total_num',total_num,'improv_ratio',improv_ratio,'stay_same',stay_same);
