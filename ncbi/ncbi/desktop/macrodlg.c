...

{
  ...
  StaticPrompt (p, "location type", 0, dialogTextHeight, systemFont, 'l');
  dlg->location_type = PopupList (p, TRUE, ChangeLocationConstraintDialogPopup);
