...
*
**************************************************/
typedef struct variantProperties {
   Uint4 OBbits__;
   Int4   version;
#define OB__VariantProperties_resource_link 0

   Int4   resource_link;
#define OB__VariantProperties_gene_function 1

   Int4   gene_function;
#define OB__VariantProperties_mapping 2

   Int4   mapping;
#define OB__VariantProperties_weight 3

   Int4   weight;
#define OB__VariantProperties_allele_freq 4

   Int4   allele_freq;
#define OB__VariantProperties_genotype 5

   Int4   genotype;
#define OB__VariantProperties_hapmap 6
