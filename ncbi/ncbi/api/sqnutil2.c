 ...
 */
static void RemoveDuplicateNestedSetsInSeqEntry (SeqEntryPtr top_sep)
{
  ...
  while (sep != NULL) {
    sep_next = sep->next;
    RemoveDuplicateNestedSetsInSeqEntry (sep);
    if (IS_Bioseq_set (sep) 
...
NLM_EXTERN void RemoveDuplicateNestedSetsForEntityID (Uint2 entityID)
{
  SeqEntryPtr       top_sep;
  ...
  RemoveDuplicateNestedSetsInSeqEntry(top_sep);
