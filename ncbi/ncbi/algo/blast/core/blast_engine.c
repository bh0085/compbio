/* $Id: blast_engine.c,v 1.262 2010/05/06 18:54:32 kazimird Exp $
 * ===========================================================================
 *
...
NCBI_XBLAST_EXPORT const int   kBlastPatchVersion = 23;
NCBI_XBLAST_EXPORT const char* kBlastReleaseDate = "Feb-03-2010";
